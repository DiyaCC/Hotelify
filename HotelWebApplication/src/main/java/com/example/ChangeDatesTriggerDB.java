...
public class ChangeDatesTriggerDB {
    ...
    public static void main(String[] args) {
        ...
        String JDBC_PASS = "Matara!92222";     // Change if needed
        Connection con = null;
        ...
        try {
            ...
            String datesTriggerFunction =
                    ...
                    "RETURNS TRIGGER AS $$ " +
                    "BEGIN " +
                    "IF NEW.checkin_date < CURRENT_DATE OR NEW.checkout_date < CURRENT_DATE OR NEW.checkout_date < NEW.checkin_date THEN " +
